...
internal class RoundingNumbers
{
    private static void Main()
    {
        ...
        do
        {
            ...
            if (double.TryParse(input!.Replace(",", "."), out decimalValue)) break;
        ...
        while (true)
        {
            ...
            if (int.TryParse(input, out decimalLength) && decimalLength is >= 1 and <= 15) break;
        ...
        var output = roundedString.Replace(".", decimalSeparator);
